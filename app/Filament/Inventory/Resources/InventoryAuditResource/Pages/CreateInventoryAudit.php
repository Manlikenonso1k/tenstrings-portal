...
class CreateInventoryAudit extends CreateRecord {
 ...
 protected function mutateFormDataBeforeCreate(array $data): array { $data['conducted_by'] = auth()->id(); $data['started_at'] = now(); $data['status'] = $data['status'] ?? 'draft'; return $data; }
